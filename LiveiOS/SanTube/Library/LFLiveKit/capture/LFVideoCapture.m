...
- (void)setFilterLevel:(NSInteger)filterLevel{
...
//    }
    switch (self.filterLevel) {
        ...
        case 1:{
            self.output = [[GPUImageSketchFilter alloc] init];
            self.filter = [[GPUImageSketchFilter alloc] init];
            self.beautyFilter = nil;
            break;
        }
        case 2:{
            self.output = [[GPUImageSaturationFilter alloc] init];
            self.filter = [[GPUImageSaturationFilter alloc] init];
            [(GPUImageSaturationFilter *)self.filter setSaturation:0.1];
            self.beautyFilter = nil;
            break;
        }
        case 3:{
            self.output = [[GPUImageRGBFilter alloc] init];
            self.filter = [[GPUImageRGBFilter alloc] init];
            [(GPUImageRGBFilter *)self.filter setGreen:0.5];
            self.beautyFilter = nil;
            break;
        }
        default:{
