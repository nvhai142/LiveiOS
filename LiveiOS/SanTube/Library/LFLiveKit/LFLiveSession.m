...
- (void)setFilterLevel:(NSInteger)filterLevel {
    [self willChangeValueForKey:@"filterLevel"];
    [self.videoCaptureSource setFilterLevel:filterLevel];
    [self didChangeValueForKey:@"filterLevel"];
}
-(void)setVideoFilter:(FilterVideoType)type{
